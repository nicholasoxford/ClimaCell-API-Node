let loadJson,saveJSON,chalk;_ff7‍.x([["filterJson",()=>filterJson],["compareData",()=>compareData]]);_ff7‍.w("./jsonCRUD",[["loadJson",["loadJson"],function(v){loadJson=v}],["saveJSON",["saveJSON"],function(v){saveJSON=v}]]);_ff7‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);
...
//This checks if there are any repeats in long and latitude data
  ...
  _ff7‍.g.console.log(chalk.blue("-"));
  _ff7‍.g.console.log(chalk.blue("--"));
  _ff7‍.g.console.log(chalk.blue("---"));
  _ff7‍.g.console.log("Download + Filtering of location data is ", chalk.green.bold("done."));
  _ff7‍.g.console.log("The amount of repeat locations is: ", listOfRepeats.length);
  _ff7‍.g.console.log("The amount of unique location is: ", jsonArray.length);
  _ff7‍.g.console.log(chalk.blue("---"));
  _ff7‍.g.console.log(chalk.blue("--"));
  _ff7‍.g.console.log(chalk.blue("-"));
