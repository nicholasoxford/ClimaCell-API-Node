let loadJson,saveJSON,chalk;_c58‍.x([["filterJson",()=>filterJson],["compareData",()=>compareData]]);_c58‍.w("./jsonCRUD",[["loadJson",["loadJson"],function(v){loadJson=v}],["saveJSON",["saveJSON"],function(v){saveJSON=v}]]);_c58‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);
...
//This checks if there are any repeats in long and latitude data
  ...
  _c58‍.g.console.log(chalk.blue("-"));
  _c58‍.g.console.log(chalk.blue("--"));
  _c58‍.g.console.log(chalk.blue("---"));
  _c58‍.g.console.log("Download + Filtering of location data is ", chalk.green.bold("done."));
  _c58‍.g.console.log("The amount of repeat locations is: ", listOfRepeats.length);
  _c58‍.g.console.log("The amount of unique data points: is ", jsonArray.length);
  _c58‍.g.console.log(chalk.blue("---"));
  _c58‍.g.console.log(chalk.blue("--"));
  _c58‍.g.console.log(chalk.blue("-"));
