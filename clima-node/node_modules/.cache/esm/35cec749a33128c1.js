let loadJson,saveJSON,chalk;_a33‍.x([["filterJson",()=>filterJson],["compareData",()=>compareData]]);_a33‍.w("./jsonCRUD",[["loadJson",["loadJson"],function(v){loadJson=v}],["saveJSON",["saveJSON"],function(v){saveJSON=v}]]);_a33‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);
...
//This checks if there are any repeats in long and latitude data
  ...
  _a33‍.g.console.log(chalk.blue("-"));
  _a33‍.g.console.log(chalk.blue("--"));
  _a33‍.g.console.log(chalk.blue("---"));
  _a33‍.g.console.log("Download + Filtering of location data is ", chalk.green.bold("done."));
  _a33‍.g.console.log("The amount of repeat locations is: ", listOfRepeats.length);
  _a33‍.g.console.log("The amount of unique location is: ", jsonArray.length);
  _a33‍.g.console.log(chalk.blue("---"));
  _a33‍.g.console.log(chalk.blue("--"));
  _a33‍.g.console.log(chalk.blue("-"));
